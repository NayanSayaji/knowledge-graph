...
export class GitHubClient {
  ...
  private async repositoryExists(owner: string, repository: string) {
  ...
  async createAvailableRepository(
    ...
    while (suffix < 1_000) {
      ...
      if (!(await this.repositoryExists(user.login, candidate))) {
        return this.request<CreatedRepository>("/user/repos", {
          method: "POST",
          body: JSON.stringify({
            name: candidate,
            description:
